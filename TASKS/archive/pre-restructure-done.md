...
## Restructure note, 2026-08-05 — the duplicate T-03

The old `TASKS.md` carried T-03 twice: this struck-through closure, and a second open heading
reusing the id. The open copy was **not about the injection site** — its body was the postmortem of
the stale-tree incident plus a pointer to T-50. Nothing in it belonged in T-07, so it was moved here
rather than merged, and the queue copy deleted. Per rule 13, a duplicate removed leaves a note
saying what happened. Text follows verbatim.
